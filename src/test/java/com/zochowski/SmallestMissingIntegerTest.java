...
public class SmallestMissingIntegerTest {
    ...
    public void moreTests() {
        ...
        Assertions.assertEquals(1, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{-999999, 1000000}));
        Assertions.assertEquals(2, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{1, 500, 1000000}));
        Assertions.assertEquals(1, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{0}));
        Assertions.assertEquals(1, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{-3}));
        Assertions.assertEquals(4, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{1,2,3,11,20}));
        Assertions.assertEquals(1, smallestMissingInteger.findSmallestPositiveIntegerFromArray(new int[]{}));
    }
}
